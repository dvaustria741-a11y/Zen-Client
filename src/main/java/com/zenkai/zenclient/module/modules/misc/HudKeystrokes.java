...
/** Misc module that shows/hides the Keystrokes HUD element. */
public final class HudKeystrokes extends Module {

    public HudKeystrokes() {
        super("HUD Keystrokes", "Toggle the Keystrokes HUD.", Category.MISC, Keyboard.KEY_NONE);
    }

    @Override
    public void onEnable() {
        super.onEnable();
        HudElement el = ZenClient.getInstance().getHudManager().getElement("Keystrokes");
